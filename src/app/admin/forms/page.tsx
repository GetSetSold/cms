...
import { FormDuplicateButton } from "@/components/admin/FormDuplicateButton";
        ...
        <div className="overflow-hidden rounded-2xl bg-white">
          <table className="w-full text-left">
            <thead className="border-b border-line text-xs uppercase tracking-wide text-muted">
              <tr><th className="p-4">Name</th><th className="p-4">Link</th><th className="p-4">Type</th><th className="p-4">Leads tagged</th><th className="p-4">Status</th><th className="w-12 p-4" /></tr>
            </thead>
            <tbody>
              {(forms ?? []).map((f) => (
                <tr key={f.id} className="border-b border-line/60 last:border-0 hover:bg-ground/60">
                  ...
                  <td className="p-4"><FormDuplicateButton formId={f.id} /></td>
                </tr>
              ))}
            </tbody>
          </table>
